...
<body class="bg-light">
  ...
  <div class="container py-5" style="min-height: 72vh">
    <div class="p-4 rounded-4 shadow-lg" style="background: linear-gradient(135deg, #e0c3fc, #8ec5fc);">
      ...
      <div class="d-flex">
        <button type="button" id="agregarProductoBtn" class="btn btn-light d-flex justify-content-center m-auto" data-bs-whatever="@mdo"><i class="bi bi-plus"> Agregar rol</i></button>
            ...
            <div class="modal-body">
              <form class="needs-validation" id="form" enctype="multipart/form-data">
                <div class="mb-3">
                  ...
                  <input type="text" id="rodescripcion" name="rodescripcion" class="form-control" required maxlength="100"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" id="formEdicion">
              <div class="mb-3">
                <label for="rodescripcion" class="col-form-label">Nombre del rol</label>
                <input type="text" id="rodescripcionEdicion" class="form-control" name="rodescripcionEdicion" required maxlength="100"
