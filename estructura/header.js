document.addEventListener("DOMContentLoaded", () => {
  ...
  if (rol === 1) {
    ...
    badge.className =
      "badge bg-danger text-white border border-light shadow-sm d-flex align-items-center px-3 py-2 me-2";
  ...
  document
    ...
    .addEventListener("click", () => cambiarRol(1));
  document
    .getElementById("verCliente")
    .addEventListener("click", () => cambiarRol(2));
